...
[Table("pfms_head_details", Schema = "ifmsadmin")]
[Index("HoaId", "CentralFunctionHead", "ObjectHead", Name = "hoa_id_central_function_head_object_head_unique_key1", IsUnique = true)]
public partial class PfmsHeadDetail
{
    [Key]
    [Column("id")]
